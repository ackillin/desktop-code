...
def miller(num, d):
    # Rend below gets a positive int from 0 to num-4. We then add 2 to get rid
    # of obviously non prime numbers
    ...
    # While we haven't gone to or past the prime, keep checking to see if its
    # probably prime
...
def get_prime(bits):
    ...
    while is_prime(get_prime.prime, rounds=5) is False:
        get_prime.prime = secrets.randbits(bits)
